    ...
    return (
		<Page>
			<div className='ml-20 mr-20'>
				...
				<p className='mt-10 font-mono'>Hey!My name is Carlos, I have a degree in computer engineering and I am currently working on my masters thesis.</p>
				...
				<p className='font-mono mt-3'>Im a simple person with the goal of learning more and improving as a developer. In my free time, I love playing games and watching anime.😉</p>
			</div>
		</Page>
